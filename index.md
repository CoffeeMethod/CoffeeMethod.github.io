...
title: Coffee Method
hide_title: true
description: "Coffee Method: developer, tinkerer, and maintainer of a few small open source projects."
---
...
Open an issue on one of my repos, or email me. (Add your address to
`social_links.email` in `_config.yml` and it appears in the footer on every page.)
